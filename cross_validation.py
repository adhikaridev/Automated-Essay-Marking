...
path = '/home/sudo-this/PycharmProjects/Automated Essay Marking/cross_validation/*.txt'
...
for filename in sorted(files):
    ...
    abs_error = abs(human_rated_score - round(predicted_score,0))
    sum_of_error = sum_of_error + abs_error
    print '\n','    Human-rated score: ', human_rated_score
    print '\n','    Predicted score: ',round(predicted_score,0)
    print '\n','    Error in prediction: ',abs_error
average_error = sum_of_error/file_id
print '\n','Sum of errors in validation set: ',sum_of_error
print '\n','Total data points in validation set: ',file_id
