...
datadir = 'just for test/lessErrors/'
...
path = '/home/sudo-this/PycharmProjects/Automated Essay Marking/just for test/lessErrors/*.txt'
files = glob.glob(path)
file_id = 0
with open('numerical_features_lessErrors.csv', 'wb') as csv_file:
